/*
 * @class Calendar ~jquery-calendar plugin~ (https://github.com/28karonte/jquery-calendar-bs4)
 * @author Developped by EMC
 * Some Improvements, refactorizations and fixes: M. A. Coma Rivas, E. Molina Cortijos
 * @license Licensed under MIT (https://github.com/28karonte/jquery-calendar/blob/master/LICENSE)
 */
...
jQuery(document).ready(function ($) {
            ...
            if (day === false) {
                ...
                for (var f = 0; f <= differenceDays; f++) {
                    ...
                    this.drawEventsOrDaynotes(
                        ...
                        moment.unix(e.start).format('DD MM YYYY HH:mm:ss') + ' - ' + moment.unix(e.end).format('DD MM YYYY HH:mm:ss'),
                        ['calendar-event']
                    );
    ...
    Calendar.prototype.drawModal = function () {
        var modal = '<div class="modal fade" id="calendar-modal" tabindex="-1" role="dialog">';
    ...
    Calendar.prototype.getCategories = function (object, attribute1, attribute2) {
        var categories = [], e, n = object.length, fromTimeStamp = parseInt(this.fromTimestamp),
